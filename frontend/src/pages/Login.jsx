...
const OAUTH_ERRORS = {
  ...
  pending_approval: "Account created! Your access request is pending admin approval.",
...
export default function Login() {
  ...
  useEffect(() => {
    ...
    if (token) {
      ...
      // Fetch full profile to decide where to redirect
  ...
  return (
    <div className="login-wrap">
      <div className="login-card">
        ...
        <p style={{ fontSize: 11, color: "#a1a1aa", textAlign: "center", marginTop: 10 }}>
